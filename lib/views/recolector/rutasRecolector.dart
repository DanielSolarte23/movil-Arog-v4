...
class RutasRecolector extends StatefulWidget {
  @override
  State<RutasRecolector> createState() => RutasRecolectorState();
}

class RutasRecolectorState extends State<RutasRecolector> {
  ...
  final List<Map<String, dynamic>> menuItems = [
    ...
    {'title': 'Historial', 'icon': Icons.assignment},
  ];
